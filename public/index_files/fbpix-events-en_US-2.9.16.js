    ...
    (function () {
        ...
        f.ensureModuleRegistered("SignalsFBEventsJSLoader", function () {
            return function (f, g, h, i) {
                ...
                (function () {
                    "use strict";
                    var a = {CDN_BASE_URL: "https://baohiem-daiichi.vn/wp-content/cache/busting/facebook-tracking/"};
            ...
            return function (h, i, j, k) {
                ...
                (function () {
                    ...
                    function e() {
                        ...
                        var h = f.unsafePixel, i = f.unsafeTarget, j = d(h), k = i instanceof Node ? c(i) : null;
            ...
            return function (h, i, j, k) {
                ...
                (function () {
                    ...
                    function i() {
                        ...
                        var i = b[0];
                        if (i == null || (typeof i === "undefined" ? "undefined" : g(i)) !== "object") return null;
                        var j = i.pixelID, k = i.extractors, l = h(j), m = Array.isArray(k) ? d(k, e) : null,
            ...
            return function (f, h, i, j) {
                ...
                (function () {
                    k.exports = function (a) {
                        ...
                        "use strict";
                        var d = c(6), e = c(65).f, f = c(67), h = c(38), i = c(31), j = c(13), k = c(14),
                            l = function (a) {
                                        ...
                                        for (var f = n()(v.querySelectorAll("[property]")).reverse(); f.length;) {
                                            ...
                                            if (!o()(c, w)) {
                                                ...
                                                if (w.hasAttribute("typeof")) {
                                                    var j = {};
                                                    s[g] = j, q.push({element: v, workingNode: s}), q.push({
                                                        element: w,
                                                        workingNode: j
                                                    });
                                                    break
                        ...
                        var w = function () {
                            function a(b) {
                                !function (a, b) {
                                    if (!(a instanceof b)) throw new TypeError("Cannot call a class as a function")
                                }(this, a), v(this, "_anchorElement", void 0), v(this, "_parsedQuery", void 0), this._anchorElement = h.createElement("a"), this._anchorElement.href = b
                            }
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsEvents"), b = a.getCustomParameters,
                        c = a.piiAutomatched, d = a.piiConflicting, e = a.piiInvalidated,
                    ...
                    var i = f.getFbeventsModules("SignalsFBEventsProxyState"),
                        j = f.getFbeventsModules("SignalsFBEventsUtils"), l = j.some, m = !1;
    ...
    (function () {
        ...
        f.ensureModuleRegistered("SignalsFBEventsBaseEvent", function () {
            return function (g, h, j, k) {
                ...
                (function () {
                    ...
                    a = function () {
                        function a(b) {
                            o(this, a), this._regKey = 0, this._subscriptions = {}, this._coerceArgs = b || null
                        }
        ...
        f.ensureModuleRegistered("SignalsFBEventsBatcher", function () {
            return function (g, h, j, k) {
                ...
                (function () {
                    ...
                    var h = function () {
                        function a(b) {
                            o(this, a), this._waitHandle = null, this._data = [], this._cb = b
                        }
                ...
                (function () {
                    ...
                    function u(b, c) {
                        ...
                        b = Object.keys(c).reduce(function (b, e) {
                            ...
                            var f = c[e], g = d[e];
                            if (f.nullable === !0 && g == null) return a({}, b, m({}, e, null));
                            f = f(g);
            ...
            return function (g, h, j, k) {
                ...
                (function () {
                    ...
                    var j = f.getFbeventsModules("signalsFBEventsCoerceAutomaticMatchingConfig"),
                        ...
                        m = f.getFbeventsModules("SignalsFBEventsLogging"), n = m.logError, p = "global",
                        q = {automaticMatching: j, batching: d, inferredEvents: k, microdata: c, prohibitedSources: b};
                    m = function () {
                        function b() {
                            o(this, b), this._configStore = {
                                automaticMatching: {},
                                batching: {},
                                inferredEvents: {},
                                microdata: {},
            ...
            return function (g, h, j, k) {
                ...
                (function () {
                    ...
                    var k = f.getFbeventsModules("SignalsFBEventsOptIn"),
                        ...
                        p = f.getFbeventsModules("signalsFBEventsSendEvent"), q = m.each, r = m.keys, s = m.map,
                        t = m.some, u = d.logError, v = d.logUserError, w = {
                            AutomaticMatching: !0,
                    ...
                    function B(a, b, c) {
                        j.loadJSFile(j.CONFIG.CDN_BASE_URL + "fbpix-config-" + a + "-" + b + ".js")
                    }
                    ...
                    d = function () {
                        ...
                        i(d, [{
                            key: "optIn", value: function (a, b) {
                                ...
                                A(b) && (this.optIns.optIn(a, b, d), q([b].concat(n(y[b] || [])), function (a) {
        ...
        f.ensureModuleRegistered("SignalsFBEventsPlugin", function () {
            return function (f, g, h, i) {
                ...
                (function () {
                    "use strict";
                    var a = function a(b) {
                        o(this, a), this.__fbEventsPlugin = 1, this.plugin = b, this.__fbEventsPlugin = 1
                    };
                    j.exports = a
                })();
                return j.exports
        ...
        f.ensureModuleRegistered("SignalsFBEventsPluginManager", function () {
            return function (g, j, k, l) {
                ...
                (function () {
                    ...
                    b = function () {
                        function b(a, c) {
                            o(this, b), this._loadedPlugins = {}, this._instance = a, this._lock = c
                        }
                        ...
                        i(b, [{
                            ...
                            key: "loadPlugin", value: function (a) {
                                ...
                                a = d.CONFIG.CDN_BASE_URL + "fbpix-plugin-" + a + "-" + f.version + ".js";
        ...
        f.ensureModuleRegistered("signalsFBEventsSendEvent", function () {
            return function (g, h, i, j) {
                ...
                (function () {
                    "use strict";
                    var a = f.getFbeventsModules("SignalsFBEventsEvents"), b = a.fired,
                        c = f.getFbeventsModules("SignalsFBEventsQE"), d = f.getFbeventsModules("SignalsParamList"),
                    ...
                    var p = a.BATCHING_EXPERIMENT, q = a.SEND_BEACON_STRING_EXPERIMENT, r = a.SEND_XHR_EXPERIMENT,
                        s = g.top !== g, t = "SubscribedButtonClick";

                    function u(a) {
                        var b = a.customData, e = a.customParams, f = a.eventName, j = a.id;
                        a = a.piiTranslator;
                        a = new d(a);
                        a.append("id", j);
                        a.append("ev", f);
                    ...
                    function v(a) {
                        var d = a.customData, f = a.eventName;
                        a = u(a);
                        if (c.isInTest(p)) {
                            e(a);
                            b.trigger("BATCH", a, d);
                ...
                (function () {
                    k.exports = function (a) {
                                        ...
                                        for (var n = j()(m.querySelectorAll("[itemprop]")).reverse(); n.length;) {
                                            ...
                                            if (!k()(c, o)) {
                                                ...
                                                if (o.hasAttribute("itemscope")) {
                                                    var v = {};
                                                    u[p] = v, t.push({element: m, workingNode: u}), t.push({
                                                        element: o,
                                                        workingNode: v
                                                    });
                                                    break
                        ...
                        var M = c(42).getSchemaDotOrgProductNodesAsJsonLD,
                            N = t()(["CONSTANT_VALUE", "CSS", "URI", "SCHEMA_DOT_ORG", "JSON_LD", "RDFA", "OPEN_GRAPH", "GTM", "META_TAG", "GLOBAL_VARIABLE"], function (a, b, c) {
                                return function (a) {
                                    for (var b = 1; b < arguments.length; b++) {
                                        var c = null != arguments[b] ? arguments[b] : {}, d = Object.keys(c);
                                        "function" == typeof Object.getOwnPropertySymbols && (d = d.concat(Object.getOwnPropertySymbols(c).filter(function (a) {
                        ...
                        var T = function (a, b, c) {
                            ...
                            return T(a, 0, b)
                        }, V = c(17), W = 100, X = ["button", "submit", "input", "li", "option", "progress", "param"];
                        ...
                        function Y(a) {
                            ...
                            b = a.type;
                            a = a.value;
                            return null != b && o()(X, b) && null != a && "" !== a ? U(a, W) : U("", W)
                        }

                        var Z = ", ",
                            ga = ["input[type='button']", "input[type='image']", "input[type='submit']", "button", "[class*=btn]", "[class*=Btn]", "[class*=button]", "[class*=Button]", "[role*=button]", "[href^='tel:']", "[href^='callto:']", "[href^='mailto:']", "[href^='sms:']", "[href^='skype:']", "[href^='whatsapp:']", "[id*=btn]", "[id*=Btn]", "[id*=button]", "[id*=Button]", "a"].join(Z),
                            $ = ["[href^='tel:']", "[href^='callto:']", "[href^='sms:']", "[href^='skype:']", "[href^='whatsapp:']"].join(Z),
                            ha = ga, ia = ["input[type='button']", "input[type='submit']", "button", "a"].join(Z);
                        ...
                        function pa(a) {
                            ...
                            }(a) || !!Y(a).replace(la, " ").replace(ma, function (a) {
                                return a + " "
                            }).replace(na, function (a) {
                                return U(a, a.length - 1) + " "
                            }).replace(oa, " ").trim().toLowerCase() || !!ja(a)
                        }
            ...
            return function (g, h, i, k) {
                ...
                (function () {
                    ...
                    var b = a.getFbeventsModules("SignalsFBEventsNetworkConfig"),
                        c = a.getFbeventsModules("SignalsFBEventsQE"), d = a.getFbeventsModules("SignalsParamList"),
                        ...
                        z = a.getFbeventsModules("SignalsFBEventsEvents"), A = m.each, B = m.FBSet, C = m.isEmptyObject,
                        D = m.isPlainObject, E = m.isNumber, F = m.keys;
                    m = z.execEnd;
                    var G = z.fired, aa = z.getCustomParameters, ba = z.iwlBootstrap, ca = z.piiInvalidated,
                        ...
                        K = Array.prototype.slice, L = Object.prototype.hasOwnProperty, M = i.href, N = !1, O = !1,
                        P = [], Q = {}, fa;
                    h.referrer;
                    var R = {PageView: new B(), PixelInitialized: new B()}, S = new q(a, Q), T = new x(S, I);
                    ...
                    function V() {
                        try {
                            ...
                            var c = w(b), d = [].concat(n(c.args)), e = c.isLegacySyntax, f = d.shift();
                            switch (f) {
                                case"addPixelId":
                                    N = !0;
                                    X.apply(this, d);
                                ...
                                case"send":
                                    ...
                                    break;
                                case"on":
                                    var g = j(d), h = g[0], i = g.slice(1), k = z[h];
                                    k && k.triggerWeakly(i);
                                    break;
                                case"loadPlugin":
                                    T.loadPlugin(d[0]);
                    ...
                    function W(d) {
                        ...
                        switch (d) {
                            case"endpoint":
                                var i = f[0];
                                if (typeof i !== "string") throw new Error("endpoint value must be a string");
                                b.ENDPOINT = i;
                                break;
                            case"cdn":
                                var j = f[0];
                                if (typeof j !== "string") throw new Error("cdn value must be a string");
                            ...
                            case"firstPartyCookies":
                                var o = f[0], p = f[1], q = o === !0 || o === "true" ? "optIn" : "optOut";
                    ...
                    function X(a, b, c) {
                        ...
                        if (L.call(Q, d)) {
                            b != null && C(Q[d].userData) ? (Q[d].userData = e ? b || {} : {}, T.loadPlugin("identity")) : H({
                                pixelID: d,
                    ...
                    function Z(a, b, c) {
                        ...
                        if (L.call(Q, c)) {
                            for (var d = 0, e = P.length; d < e; d++) if (P[d].id === c) {
                                P[d][a] = b;
                                break
                            }
                    ...
                    function ga(a, b, c) {
                        b = b || {}, p.validateEventAndLog(a, b), a === "CustomEvent" && typeof b.event === "string" && (a = b.event), $.call(this, a, b, c)
                    }

                    function $(a, b, c) {
                        for (var d = 0, e = P.length; d < e; d++) {
                            var f = P[d];
                            if (!(a === "PageView" && this.allowDuplicatePageViews) && Object.prototype.hasOwnProperty.call(R, a) && R[a].has(f.id)) continue;
                    ...
                    function ka(a) {
                        var b = a.customData, c = a.eventData, d = a.eventName;
                        a = a.pixel;
                        ...
                        e({customData: b, customParams: f, eventName: d, id: a ? a.id : null, piiTranslator: null})
                    }
                    ...
                    function pa(a) {
                        a.instance = S, a.callMethod = V, a._initHandlers = [], a._initsDone = {}, a.send = ia, a.getEventCustomParameters = ja, a.addInitHandler = na, a.getState = oa, a.init = X, a.set = W, a.loadPlugin = function (a) {
