					...
					<div class="Page-title">
						...
						<div class="col-md-12 text-center">
							<div class="breadcrumb-trail breadcrumbs">
								...
								<span class="sep">/</span> <span class="trail-end">About 2</span>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="accordions">
							<div class="tap-inner">
								...
								<div class="text-accordions">
									...
									<p>Duis dapibus aliquam mi, eget euismod scelerisque ut. Vivamus at elit quis urna adipiscing , Curabitur vitae velit in neque dictum blansadit. Duis dapibus aliquam mi, eget euismod sceler ut.Duis dapibus aliquam mi, eget euismod scelseerisque at elit quis urna adipiscing.</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="team-item col-xs-12 col-sm-6 col-md-3">
						<div class="team-item-block">
							...
							<div class="info-team">
								<h5>Ahmed Abd Elhaleem</h5>
								<p class="team-company">Chief Creative Designer</p>
							</div>
						</div>
					</div>
					<div class="team-item col-xs-12 col-sm-6 col-md-3">
						<div class="team-item-block">
							...
							<div class="info-team">
								<h5>Mostafa Amin</h5>
								<p class="team-company">Chief Accountant Manager</p>
							</div>
						</div>
					</div>
					<div class="team-item col-xs-12 col-sm-6 col-md-3">
						<div class="team-item-block">
							...
							<div class="info-team">
								<h5>Aeni Doe</h5>
								<p class="team-company">Chief Executive Officer</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div id="Testimonials-3col" class="owl-carousel owl-theme">
						<div class="item-testimonial">
							<div class="quote-client">
								<p>Lorem ipsum dolor sit consctetur adipiscing elit. Se Integer lore quam, adipiscing in condimentum tristique vel, eleifend sed turpis.</p>
							</div>
							<!-- End quote-client -->
